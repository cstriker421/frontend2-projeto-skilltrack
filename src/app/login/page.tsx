...
export default function LoginPage() {
  ...
  return (
    <main className="mx-auto max-w-md px-4 py-16 animate-fade-up">
      <div className="rounded-lg border border-gray-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 p-8 space-y-6">
        <div>
        ...
        >
          <input
            className="w-full rounded-md border border-gray-200 dark:border-zinc-700
              bg-white dark:bg-zinc-800 p-2.5 text-gray-900 dark:text-zinc-50
          ...
          />
          <button
            className="w-full rounded-md bg-gray-900 dark:bg-indigo-600 px-4 py-2.5 text-white
